...
| Type | Web app (Next.js App Router), multi-tenant SMA management |
...
- Research current Kemdikbud DAPODIK CSV/JSON specification for e-Rapor SMA (versi 2026).
...
*End of PLANS.md — for deep dives, see `docs/archive/`.*
