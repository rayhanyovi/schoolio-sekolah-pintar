...
const roleShowcases = [
  ...
  },
  {
    eyebrow: "untuk guru",
    title:
      "Move through daily classroom work without losing the class context.",
...
function RoleShowcase({ role }: { role: (typeof roleShowcases)[number] }) {
  ...
  const copy = (
    <div className="text-center lg:text-left">
      ...
      <h3 className="mx-auto mt-4 max-w-none text-[clamp(2.1rem,4vw,3.55rem)] font-semibold leading-[0.96] tracking-[-0.045em] text-[#13231f] dark:text-[#fffaf0] lg:mx-0 lg:max-w-[12ch]">
        {role.title}
      </h3>
      <p className="mx-auto mt-5 max-w-xl text-base leading-8 text-[#46554e] dark:text-[#b9c0b7] lg:mx-0">
        {role.body}
      </p>
        ...
        {role.features.map((feature, index) => {
          ...
          return (
            <div key={feature.title}>
              <article className="grid w-full grid-cols-[56px_1fr] gap-4 rounded-2xl border border-[#13231f]/12 bg-[#fffaf0]/68 p-4 text-left dark:border-[#fffaf0]/10 dark:bg-[#fffaf0]/5 lg:hidden">
                <span
                  aria-hidden="true"
                  className="mt-1 block aspect-square w-12 rounded-xl bg-[#d8d8d2] dark:bg-[#32413b]"
                />
                <span>
              ...
              <button
                ...
                className={`hidden w-full grid-cols-[34px_1fr] gap-3 rounded-2xl border p-4 text-left transition duration-200 hover:-translate-y-0.5 lg:grid ${
                  isActive
  ...
  //           <p className="text-sm font-semibold text-[#d7a12b]">
  //             {role.previewLabel}
  //           </p>
  ...
  //                 0{index + 1}
  //               </p>
  //               <p className="mt-1 text-sm text-[#5b685f] dark:text-[#b9c0b7]">
  //                 {label}
  //               </p>
  //             </div>
  //           ))}
  ...
  // );
  const preview = (
    <div className="hidden min-h-40 w-full bg-gray-300 rounded-lg lg:flex lg:h-full" />
  );

  return (
    <div className="min-h-0">
      <div
        className={`flex flex-col flex-1 min-h-0 gap-10 lg:flex-row lg:items-stretch lg:gap-16 ${
          role.reverse ? "lg:flex-row-reverse" : ""
        }`}
      >
        <div className="w-full flex-1 min-h-0 min-w-0">
          <div className="h-full w-full min-h-0 min-w-0">{preview}</div>
        </div>
        <div className="w-full flex-1 min-w-0">{copy}</div>
      </div>
    </div>
  );
}
...
export default function Index() {
  ...
  return (
    <main className="min-h-screen bg-[#f8f4ea] text-[#13231f] selection:bg-[#d7a12b]/30 dark:bg-[#101a17] dark:text-[#fffaf0]">
      <div className="fixed inset-0 -z-10 bg-[linear-gradient(90deg,rgba(19,35,31,0.04)_1px,transparent_1px),linear-gradient(0deg,rgba(19,35,31,0.026)_1px,transparent_1px)] bg-[length:38px_38px] dark:bg-[linear-gradient(90deg,rgba(255,250,240,0.06)_1px,transparent_1px),linear-gradient(0deg,rgba(255,250,240,0.04)_1px,transparent_1px)] dark:bg-[length:42px_42px]" />

      <header
        className={`fixed inset-x-0 top-0 z-50 transition-colors duration-200 ${
          isHeaderScrolled
            ? "border-b border-[#13231f]/10 bg-[rgba(248,244,234,0.26)] text-[#13231f] backdrop-blur-xl dark:border-[#fffaf0]/10 dark:bg-[rgba(16,26,23,0.86)] dark:text-[#fffaf0]"
            : "border-b border-transparent bg-transparent text-[#fffaf0] dark:text-[#13231f]"
        }`}
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-5 px-6 py-4 lg:px-8">
          <div
            className={`[&_*]:!text-current ${
              isHeaderScrolled
                ? "[&>div>div:first-child]:!border-[#074838]/20 [&>div>div:first-child]:!bg-[#074838] [&>div>div:first-child_*]:!text-[#fffaf0] dark:[&>div>div:first-child]:!border-[#fffaf0]/20 dark:[&>div>div:first-child]:!bg-[#fffaf0]/10"
                : "[&>div>div:first-child]:!border-[#fffaf0]/20 [&>div>div:first-child]:!bg-[#fffaf0]/10 dark:[&>div>div:first-child]:!border-[#13231f]/20 dark:[&>div>div:first-child]:!bg-[#13231f]/10"
            }`}
          >
            <BrandMark />
          </div>
          ...
          <nav
            className={`hidden items-center rounded-full border px-2 py-1 transition-colors duration-200 lg:flex ${
              isHeaderScrolled
                ? "border-[#13231f]/8 bg-[rgba(255,250,240,0.62)] dark:border-[#fffaf0]/10 dark:bg-[rgba(255,250,240,0.05)]"
                : "border-[#fffaf0]/16 bg-[#fffaf0]/6 dark:border-[#13231f]/14 dark:bg-[#13231f]/5"
            }`}
            ...
            {navItems.map((item) => (
              <a
                ...
                className={`rounded-full px-4 py-2 text-sm font-medium transition ${
                  isHeaderScrolled
                    ? "text-[#5b685f] hover:bg-[#0e6b53]/8 hover:text-[#13231f] dark:text-[#b9c0b7] dark:hover:bg-[#4fb796]/10 dark:hover:text-[#fffaf0]"
                    : "text-[#fffaf0]/78 hover:bg-[#fffaf0]/10 hover:text-[#fffaf0] dark:text-[#13231f]/72 dark:hover:bg-[#13231f]/8 dark:hover:text-[#13231f]"
                }`}
              >
                {item.label}
              </a>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Button
              ...
              className={`rounded-full px-4 font-semibold ${
                isHeaderScrolled
                  ? "text-[#263a34] hover:bg-[#0e6b53]/10 hover:text-[#074838] dark:text-[#ebe3d2] dark:hover:bg-[#4fb796]/12 dark:hover:text-[#7fd3b9]"
                  : "text-[#fffaf0] hover:bg-[#fffaf0]/10 hover:text-[#fffaf0] dark:text-[#13231f] dark:hover:bg-[#13231f]/8 dark:hover:text-[#13231f]"
              }`}
              asChild
            >
      ...
      <section className="relative overflow-hidden border-b border-[#fffaf0]/12 bg-[var(--schoolio-ink)] text-[var(--schoolio-cream)] dark:border-[#13231f]/12 dark:bg-[var(--schoolio-cream)] dark:text-[var(--schoolio-ink)]">
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(255,250,240,0.075)_1px,transparent_1px),linear-gradient(0deg,rgba(255,250,240,0.052)_1px,transparent_1px)] bg-[length:42px_42px] dark:bg-[linear-gradient(90deg,rgba(19,35,31,0.075)_1px,transparent_1px),linear-gradient(0deg,rgba(19,35,31,0.052)_1px,transparent_1px)]" />
        <div className="absolute inset-x-0 top-0 h-px bg-[rgba(215,161,43,0.7)]" />
        <div className="mx-auto grid max-w-7xl gap-14 px-6 pb-20 pt-32 lg:grid-cols-[0.86fr_1.02fr] lg:items-center lg:px-8 lg:pb-28 lg:pt-36">
          <div className="relative">
            <div className="inline-flex w-fit items-center gap-3 rounded-full border border-[#fffaf0]/16 bg-[#fffaf0]/8 px-4 py-2 text-sm font-semibold text-[#fffaf0] shadow-[0_14px_34px_rgba(0,0,0,0.12)] backdrop-blur dark:border-[#13231f]/16 dark:bg-[#13231f]/6 dark:text-[#13231f]">
              <span className="h-2 w-2 rounded-full bg-[var(--schoolio-accent)] shadow-[0_0_0_6px_rgba(215,161,43,0.18)]" />
              School operations, not just school software
            </div>

            <h1 className="mt-6 max-w-[10ch] text-[clamp(3.15rem,6.4vw,5.8rem)] font-semibold leading-[0.92] tracking-[-0.052em] text-[#fffaf0] dark:text-[#13231f]">
              The operating layer for modern schools.
            </h1>

            <p className="mt-6 max-w-2xl text-[clamp(1.02rem,1.3vw,1.18rem)] leading-8 text-[#fffaf0]/76 dark:text-[#263a34]">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Button
                variant="outline"
                className="h-12 rounded-full border-[#fffaf0]/24 bg-[#fffaf0]/6 px-6 text-base font-semibold text-[#fffaf0] hover:bg-[#fffaf0]/12 hover:text-[#fffaf0] dark:border-[#13231f]/20 dark:bg-[#13231f]/5 dark:text-[#13231f] dark:hover:bg-[#13231f]/10"
                asChild
              >
      ...
      >
        <div className="mx-auto max-w-7xl">
          ...
          <div className="relative mt-16 grid gap-8 lg:grid-cols-3 lg:gap-5">
            <div className="absolute left-[12%] right-[12%] top-8 hidden h-px bg-[#0e6b53]/26 lg:block" />
            ...
            {workflows.map(([number, title, text]) => (
              <article
                key={number}
                className="relative rounded-[24px]  p-7 pt-10 items-center flex flex-col"
              >
                <div className="w-40 h-40 bg-gray-300"></div>
                <h3 className="mt-5 text-2xl font-semibold tracking-[-0.035em] text-[#13231f] dark:text-[#fffaf0]">
                  {title}
                </h3>
                <p className="mt-4 leading-7 text-[#46554e] dark:text-[#b9c0b7] text-centerz`">
                  {text}
                </p>
              </article>
            ))}
